...
const ticketSummary = async (req, res) => {
    ...
    const AZURE_OPENAI_URL = 'https://freshdesk-comments-summary.openai.azure.com/openai/deployments/gpt-4o-deployment/chat/completions?api-version=2024-02-01';
    ...
    for (const ticket of tickets) {
        ...
        let regex = new RegExp(`\\s*(?:${pattern})[\\s\\S]*`, "gi");
